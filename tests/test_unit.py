...
def test_mongo():
    ...
    test_mongodb_migrator.Test(bundle='/home/codered/mystuff/Packages/secure-connect-cassandra-datamigrato.zip', token='/home/codered/mystuff/Packages/cassandra_datamigrato-token.json')
test_mongo()